...
missing Gurobi installation is a solver PASS. `--require-gurobi` is mandatory
for release: real Gurobi, 20,001 PWL points, regret <= 2e-6 and feasibility <=
1e-8 are required across all 400 checks.
"""
